...
/obj/item/organ/external
	...
	var/resistance = 0				   // Damage Resistance test
	var/damage_reduction = 0		   // More test
	var/hardiness = 0				   // Yet more test
	var/brute_mult = 1					// test
	var/burn_mult = 1					// teeeest
...
/obj/item/organ/external/proc/is_malfunctioning()
	return (BP_IS_ROBOTIC(src) && (brute_dam + burn_dam) >= min_broken_damage && prob(brute_dam + burn_dam))
