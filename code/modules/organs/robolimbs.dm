...
/datum/robolimb
	...
	var/list/allowed_bodytypes = list(SPECIES_HUMAN,SPECIES_IPC,SPECIES_SKRELL,SPECIES_UNATHI,SPECIES_AKULA,SPECIES_SERGAL,SPECIES_SHELL,SPECIES_VOX,SPECIES_YEOSA,SPECIES_AKULA,SPECIES_VULP,SPECIES_VASS,SPECIES_TAJ,SPECIES_CUSTOM,SPECIES_PLASMASANS)
	var/brute_mod = 0.2
	var/burn_mod = 0.2
	var/max_damage = 800
	var/min_broken_damage = 800
	var/hardiness = 12
	var/armor = 80
