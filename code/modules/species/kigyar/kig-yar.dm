/datum/species/kig_yar
	...
	blurb = "Ruutian Kig'Yar are the most commonly encountered species of Kig'Yar, known as Jackals. \
		...
		members of the Covenant. They arrived along with the Sangheili in the Bluespace collision incident."
	flesh_color = "#FF9463"
	blood_color = "#532476"
	icobase = 'code/modules/species/kigyar/r_kig-yar.dmi' //The DMI needed modification to fit the usual format (see other species' dmis)
	deform = 'code/modules/species/kigyar/r_kig-yar.dmi'
