...
#define SANGHEILI_ARMOUR_ICON 'code/modules/species/sangheili/Sangheili_Combat_Harness.dmi'
...
/obj/item/weapon/storage/backpack/sangheili
	...
	icon = 'code/modules/species/sangheili/backpack.dmi'
	icon_state = "covpack"
	item_state = null
...
/obj/item/clothing/gloves/thick/sangheili/ui_action_click()
	if(!connected_dagger.inhand_check())
		equip_dagger()
		playsound(usr, 'code/modules/sounds/Energysworddeploy.ogg',75, 1)
	else
		playsound(usr, 'code/modules/sounds/Energysworddeactivate.ogg', 50, 1)
		unequip_dagger()
...
//	stepsound = 'code/modules/sounds/walk_sounds/generic_walk.ogg'
...
//	armor_thickness_max = 20
	overshoes = 0
//	walk_sound = 'code/modules/sounds/walk_sounds/spartan_boots.ogg'
