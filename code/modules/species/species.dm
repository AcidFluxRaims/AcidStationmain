...
/datum/species
	...
	// Combat vars.
	var/total_health = 250                   // Point at which the mob will enter crit.
	...
	var/hardiness = 	 0					  // Hardiness test
	var/brute_mult = 	 1					  // Brute test
	var/burn_mult = 	 1					  // Burn test
	var/resistance =	 1					  // Resist test
	var/damage_reduction = 1				  // Reduction test
