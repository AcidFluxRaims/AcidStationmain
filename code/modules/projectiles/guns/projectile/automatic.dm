/obj/item/weapon/gun/projectile/automatic
	...
	firemodes = list(
		...
		list(mode_name="3-round bursts", burst=3, fire_delay=null, move_delay=4,    one_hand_penalty=1, burst_accuracy=list(0,0,-1,-1),       dispersion=list(0.0, 0.0, 0.5, 0.6)),
...
/obj/item/weapon/gun/projectile/automatic/armcannonsmg
	name = "Internal SMG system"
	desc = "A prototype lightweight, fast-firing submachine gun armcannon."
	icon = 'icons/obj/guns/armcannon.dmi'
	icon_state = "armcannonsmg"
	...
	slot_flags = null
	ammo_type = /obj/item/ammo_casing/flechette
	magazine_type = /obj/item/ammo_magazine/armcannonsmg
	allowed_magazines = /obj/item/ammo_magazine/armcannonsmg
	multi_aim = 1
	burst_delay = 0.85
	has_safety = 0
	fire_sound = 'sound/weapons/gunshot/acidarmcannon6.ogg'
	mag_insert_sound = 'sound/weapons/guns/interaction/smg_magin.ogg'
	mag_remove_sound = 'sound/weapons/guns/interaction/smg_magout.ogg'
	base_parry_chance = 10
	...
	//machine pistol, easier to one-hand with
	firemodes = list(
		list(mode_name="2-round burst",       burst=2, fire_delay=null,    move_delay=null, one_hand_penalty=0, burst_accuracy=null, dispersion=null),
		list(mode_name="5-round bursts", burst=5, fire_delay=null, move_delay=0,    one_hand_penalty=0, burst_accuracy=list(0,0,-1,-1),       dispersion=list(0.0, 0.0, 0.2, 0.4)),
		list(mode_name="saturation fire",   burst=15, fire_delay=null, move_delay=0,    one_hand_penalty=0, burst_accuracy=list(0,0,-1,-1,-1,-1,-1,-1), dispersion=list(0.0, 0.0, 0.0, 0.2, 0.2, 0.4, 0.4, 0.6)),
		)

/obj/item/weapon/gun/projectile/automatic/armcannonmg
	name = "Internal MG system"
	icon = 'icons/obj/guns/armcannon.dmi'
	icon_state = "armcannonmg"
	item_state = "armcannon"
	...
	slot_flags = null
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/armcannonmg
	allowed_magazines = /obj/item/ammo_magazine/armcannonmg
	one_hand_penalty = 0
	accuracy_power = 7
	accuracy = 5
	fire_delay = 0
	...
	bulk = null
	has_safety = 0
	fire_sound = 'sound/weapons/gunshot/acidarmcannon1.ogg'
	...
	firemodes = list(
		list(mode_name="double tap",       burst=2, fire_delay=null,    move_delay=null, one_hand_penalty=0, burst_delay = 1, burst_accuracy=null, dispersion=null),
		list(mode_name="3-round bursts", burst=3, fire_delay=null, move_delay=0,    one_hand_penalty=0, burst_delay = 1, burst_accuracy=list(0,0,0),       dispersion=list(0.0, 0.6, 1.0)),
...
/obj/item/weapon/gun/projectile/automatic/machine_pistol
	...
	firemodes = list(
		...
		list(mode_name="controlled bursts",   burst=8, fire_delay=null, move_delay=4,    one_hand_penalty=6, burst_accuracy=list(0,-1,-1,-1,-2,-2,-3,-3), dispersion=list(0.6, 0.6, 1.0, 1.0, 1.2, 1.2, 1.4, 1.4)),
		)
...
/obj/item/weapon/gun/projectile/automatic/assault_rifle
	...
	fire_sound = 'sound/weapons/gunshot/acidARheavy.ogg'
	mag_insert_sound = 'sound/weapons/guns/interaction/ltrifle_magin.ogg'
	mag_remove_sound = 'sound/weapons/guns/interaction/ltrifle_magout.ogg'
	base_parry_chance = 20
	...
	firemodes = list(
		...
		list(mode_name="short bursts",   burst=6, fire_delay=null, move_delay=6,    one_hand_penalty=11, burst_accuracy=list(0,-1,-2,-3,-3,-3), dispersion=list(0.6, 1.0, 1.2, 1.2, 1.5, 1.5)),
		)
...
/obj/item/weapon/gun/projectile/automatic/bullpup_rifle
	...
	fire_sound = 'sound/weapons/gunshot/acidARmedium.ogg'
...
/obj/item/weapon/gun/projectile/automatic/l6_saw
	name = "L6 SAW"
	desc = "The HelTek Optimus L6 SAW is a military-grade light machine gun designed for sustained supressing fire."
...
/obj/item/weapon/gun/projectile/automatic/fal
	name = "AI L1A1 remanufactured"
	desc = "An icon of years long past, this long rifle is hard-hitting and accurate, though full-auto suffers. Updated to utilize modern projectiles."
	icon = 'icons/The_OZZIE_BLOODY_PACKO_3_1.dmi'
	icon_state = "l1 a1"
	item_state = "l1a1"
	w_class = ITEM_SIZE_HUGE
	force = 10
	...
	wielded_item_state = "l1a1"
	fire_sound = 'sound/weapons/gunshot/acidFAL.ogg'
	mag_insert_sound = 'sound/weapons/guns/interaction/ltrifle_magin.ogg'
	mag_remove_sound = 'sound/weapons/guns/interaction/ltrifle_magout.ogg'
	base_parry_chance = 20
	...
	firemodes = list(
		list(mode_name="semi auto",       burst=1, fire_delay=null,    move_delay=null, one_hand_penalty=8, burst_accuracy=null, dispersion=null),
		list(mode_name="3-round bursts", burst=3, fire_delay=null, move_delay=6,    one_hand_penalty=9, burst_accuracy=list(0,-1,-1),       dispersion=list(0.0, 0.6, 1.0)),
		list(mode_name="short bursts",   burst=6, fire_delay=null, move_delay=6,    one_hand_penalty=11, burst_accuracy=list(0,-1,-2,-3,-4,-5), dispersion=list(0.6, 1.0, 1.2, 1.5, 1.8, 1.8)),
		)

/obj/item/weapon/gun/projectile/automatic/lewisgun
	name = "Lewis Gun"
	desc = "A classic, early light machine gun. The water jacket is thankfully empty, and it has been rechambered in modern ammunition for convenience."
	...
	ammo_type = /obj/item/ammo_casing/rifle
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/box/lewisgun
	allowed_magazines = list(/obj/item/ammo_magazine/box/lewisgun)
	one_hand_penalty = 15
	wielded_item_state = "lewisgun"
	fire_sound = 'sound/weapons/gunshot/acidlewis.ogg'
	mag_insert_sound = 'sound/weapons/guns/interaction/lmg_magin.ogg'
	mag_remove_sound = 'sound/weapons/guns/interaction/lmg_magout.ogg'
	...
	//No single-shot or 3-round-burst modes since using this weapon should come at a cost to flexibility.
	firemodes = list(
		list(mode_name="short bursts",	can_autofire=0, burst=2, fire_delay=3, move_delay=12, one_hand_penalty=8, burst_accuracy = list(0,0,-1,-2,-2), dispersion = list(0.3, 0.6, 1.0, 1.0, 1.2)),
		list(mode_name="concentrated fire",	can_autofire=0, burst=5, fire_delay=4, one_hand_penalty=12, burst_accuracy = list(0,-1,-1,-2,-2,-2,-3,-3), dispersion = list(1.0, 1.0, 1.0, 1.0, 1.2)),
		list(mode_name="suppressive fire",		can_autofire=0, burst=10, fire_delay=10, one_hand_penalty=12, burst_accuracy = list(0,-1,-1,-2,-2,-2,-3,-3), dispersion = list(1.0, 1.0, 1.0, 1.2, 1.2)),
		)