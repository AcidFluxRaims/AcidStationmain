...
/obj/item/weapon/gun/projectile/heavysniper/armcannonsniper
	name = "Internal Ballistic Sniper System"
	desc = "A prototype internal cannon mounted within a mechanical arm."
	icon = 'icons/obj/guns/armcannon.dmi'
	icon_state = "armcannonsniper"
	...
	magazine_type = /obj/item/ammo_magazine/armcannonsniper
	allowed_magazines = /obj/item/ammo_magazine/armcannonsniper
	max_shells = 30
	ammo_type = /obj/item/ammo_casing/shell
	one_hand_penalty = 0
	accuracy = 5
...
/obj/item/weapon/gun/projectile/heavysniper/armcannonrocket
	...
	desc = "A prototype internal rocket projector mounted within a mechanical arm."
	icon = 'icons/obj/guns/armcannon.dmi'
	icon_state = "armcannonlauncher"
	item_state = "armcannon"
	w_class = ITEM_SIZE_HUGE
	force = 10
	slot_flags = null
	...
	has_safety = 0
	load_sound = 'sound/weapons/guns/interaction/rifle_load.ogg'
	fire_sound = 'sound/weapons/gunshot/acidlauncher.ogg'
	fire_delay = 15
	wielded_item_state = null
...
/obj/item/weapon/gun/projectile/heavysniper/boltaction
	name = "Mosin-Nagant M44 modernized"
	desc = "An old bolt action rifle from some forgotten war, still commonplace among farmers and colonists as an anti-varmint rifle. Lighter than most other bolt-action rifles while still retaining the power."
...
/obj/item/weapon/gun/projectile/heavysniper/enfield4
	...
	desc = "An old bolt action rifle from some forgotten war, still commonplace among farmers and colonists as an anti-varmint rifle. Holds ten rounds, a reliable, slightly updated standby."
	icon = 'icons/obj/guns/leerifles.dmi'
	icon_state = "No. 4"
	item_state = "No. 4"
	w_class = ITEM_SIZE_HUGE
