...
/obj/item/weapon/gun/projectile/revolver/medium/captain/large
	...
	desc = "A shiny al-Maliki & Mosley Autococker automatic revolver, with black accents. Up-chambered for a .454 calibre round. This one has 'To the Captain of the IFSS Independence' engraved on the grip."
...
/obj/item/weapon/gun/projectile/revolver/medium/captain/large/xo
	name = "Final Argument"
	desc = "A shiny al-Maliki & Mosley Autococker automatic revolver, with black accents. Marketed as the 'Revolver for the Modern Era'. This one has 'To the Executive of the IFSS Independence' engraved on the grip."
	ammo_type = /obj/item/ammo_casing/pistol/magnum
	caliber = CALIBER_PISTOL_MAGNUM
