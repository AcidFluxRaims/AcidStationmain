...
/obj/item/clothing/head/soft/slouchflat
	name = "Australian slouch hat, unpinned"
	desc = "An ancient piece of headgear. Looks durable-ish."
	icon_state = "slouchflat"
	item_state = "slouchflat"

/obj/item/clothing/head/soft/slouchpinned
	name = "Australian slouch hat, pinned"
	desc = "An ancient piece of headgear. Looks durable-ish, with a slight nod to style."
	icon_state = "slouchpinned"
	item_state = "slouchpinned"
