...
/obj/item/clothing/under/ozuni
	desc = "An ancient set of fatigues from a long-lost era."
	name = "Australian WW1 Fatigues"
	icon_state = "anzac" // WHAT THE FUCK. This literally works for every other object.
	worn_state = "anzac"
	gender_icons = 0
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
