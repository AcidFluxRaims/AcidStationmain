...
/obj/item/weapon/gun/energy/plasmapistol
	...
	fire_sound = 'code/modules/sounds/haloplasmapistol.ogg'
	charge_meter = 1
	max_shots = 125
	slowdown_general = 0
...
//	overheat_sfx = 'code/modules/sounds/plaspistol_overheat.ogg'
//	alt_charge_method = 1
	...
	item_icons = list(
		...
		slot_s_belt_str = 'code/modules/weapons/icons/Belt_Weapons.dmi',
		)
...
/obj/item/weapon/gun/projectile/needler // Uses "magazines" to reload rather than inbuilt cells.
	...
	fire_sound = 'code/modules/sounds/needlerfire.ogg'
