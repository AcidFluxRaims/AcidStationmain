...
/obj/item/weapon/melee/energy/elite_sword
	...
	icon = 'code/modules/weapons/icons/Covenant Weapons.dmi'
...
//	activate_sound = 'code/modules/sounds/Energysworddeploy.ogg'
//	deactivate_sound = 'code/modules/sounds/Energysworddeactivate.ogg'
...
//		parry_slice_objects = 0
		...
		item_icons = list(slot_l_hand_str ='code/modules/icons/Energy Sword_inhand Human.dmi',slot_r_hand_str = 'code/modules/icons/Energy Sword_inhand Human.dmi')
		item_state_slots = list(
		slot_l_hand_str = "[inhand_icon_state] l",
		slot_r_hand_str = "[inhand_icon_state] r" )
		hitsound = 'code/modules/sounds/Energyswordhit.ogg'
...
//		parry_slice_objects = 0
		...
		item_icons = list(slot_l_hand_str ='code/modules/icons/energy_dagger_inhand.dmi',slot_r_hand_str = 'code/modules/icons/energy_dagger_inhand.dmi')
		item_state_slots = list(
...
/obj/item/weapon/melee/energy/elite_sword/honour_staff
	...
	damtype = PAIN
	item_icons = list(
		slot_l_hand_str = 'code/modules/weapons/icons/Weapon_Inhands_left.dmi',
		slot_r_hand_str = 'code/modules/weapons/icons/Weapon_Inhands_right.dmi',
		)
	item_state_slots = list(
...
Luckily, this isn't a downside due to the explosive properties of such a large and quick grown crystal."
	icon = 'code/modules/weapons/icons/blamite.dmi'
	icon_state = "invalid"
	item_icons = list(slot_l_hand_str ='code/modules/weapons/icons/Weapon_Inhands_right.dmi',slot_r_hand_str = 'code/modules/weapons/icons/Weapon_Inhands_right.dmi')
	w_class = ITEM_SIZE_LARGE
