...
/obj/item/projectile/bullet/covenant/plasmapistol
	...
	icon = 'code/modules/weapons/icons/Covenant_Projectiles.dmi'
...
//		if(istype(m))
//			m.apply_damage(our_dam, BURN, null, NEEDLER_SHRAPNEL_AP))
//			m.embedded -= src
//			m.pinned -= src
//			if(m.pinned.len == 0)
//				m.anchored = 0
...
/obj/item/ammo_magazine/fuel_rod
	...
	icon = 'code/modules/weapons/icons/fuel_rod_cannon.dmi'
...
/obj/item/projectile/bullet/covenant/concussion_rifle/on_impact(var/atom/A)
	playsound(A, 'code/modules/sounds/conc_rifle_explode.ogg', 100, 1)
