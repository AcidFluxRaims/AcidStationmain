...
/obj/item/weapon/gun/projectile/shotgun/pump/m90_ts
	...
	icon = 'code/modules/weapons/icons/Weapon Sprites.dmi'
	icon_state = "m90"
	item_state = "m90"
	fire_sound = 'code/modules/sounds/Shotgun_Fire_New.wav'
	//reload_sound = 'code/modules/sounds/Shotgun_Reload_New.wav'
	...
	var/on = 0
	var/activation_sound = 'code/modules/sounds/Assault_Rifle_Flashlight.wav'
	...
	item_icons = list(
		...
		slot_back_str = 'code/modules/weapons/icons/Back_Weapons.dmi',
		slot_s_store_str = 'code/modules/weapons/icons/Armor_Weapons.dmi',
		)
...
/obj/item/weapon/gun/projectile/shotgun/soe
	...
	accuracy = -1
	dispersion = list(0.45)
//	hud_bullet_reffile = 'code/modules/icons/hud_display/hud_bullet_7x8.dmi'
//	hud_bullet_iconstate = "shell"
//	hud_bullet_row_num = 2
	...
	fire_sound = 'code/modules/sounds/Shotgun_Shot_Sound_Effect.ogg'
