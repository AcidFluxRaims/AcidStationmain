...
/obj/item/documents/nanotrasen
	...
	desc = "\"Top Secret\" corporate documents, filled with complex diagrams, research procedures, and details on cloning or breeding rights to non-sapient species the Independence encounters. It seems like they will be auctioning them off to the highest private bidder."
...
/obj/item/documents/scg/verified
	...
	desc = "\"Top Secret\" documents detailing SCG IFF codes, granting the Independence access into restricted sectors. The majority of them are coordinates, codes for fellow ships, and clearance lists."
...
/obj/item/documents/scg/brains
	...
	desc = "Heavily classified medical documentation of brain scans and exploratory surgery conducted across the entire length of the Dagon and Independence project. It seems like they have been documenting how deep-space living has altered the structure of the brain."
	description_antag = "These studies were conducted, without consent, while the patients were under anaesthesia for some other routine medical concern. They detail some very unusual deformities within the deepest parts of the brain, correlating them with the people and places visited by the Dagon and Independence 'for later assessment'. The findings, and any 'viable specimens', are to be delivered to a black site on S/2004 N 1."
	icon_state = "docs_verified"
...
/obj/item/documents/scg/blue
	...
	desc = "\"Top Secret\" documents detailing the Skrellian company Krri'gli, and their insistent requests upon specific priority sectors for the Independence to investigate."
	description_antag = "Krri'gli seem to be guiding the Independence, subtly, to a specific unmapped sector of the galaxy. It's almost like they're too afraid to investigate it personally."
