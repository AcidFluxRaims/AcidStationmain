...
/datum/objective/nuclear
	explanation_text = "Extract a ransom, or resources, from the IFSS Independence with the threat of your nuclear device. Take hostages, make examples. Be creative."
