...
// Click cooldown
#define DEFAULT_ATTACK_COOLDOWN 6 //Default timeout for aggressive actions
#define DEFAULT_QUICK_COOLDOWN  3
...
#define SYNTH_HEAT_LEVEL_1 1250
#define SYNTH_HEAT_LEVEL_2 2000
#define SYNTH_HEAT_LEVEL_3 4250
