...
/music_track/final_frontier
	title = "Final Frontier"
	album = "Johnathan Young"
	artist = "Johnathan Young"
	song = 'sound/music/acid/final_frontier.ogg'
	license = /decl/license/cc_by_nc_sa_3_0
	url = null

/music_track/starlight_brigade
	title = "Starlight Brigade"
	album = "Starlight Brigade"
	artist = "TWRP featuring Dan Avidan"
	song = 'sound/music/acid/starlight_brigade.ogg'
	license = /decl/license/cc_by_nc_sa_3_0
	url = null

/music_track/valhalla_calling
	title = "Valhalla Calling"
	album = "Miracle of Sound"
	artist = "Miracle of Sound"
	song = 'sound/music/acid/valhalla_calling.ogg'
	license = /decl/license/cc_by_nc_sa_3_0
	url = null
