/datum/species/sergal
	...
	hunger_factor = DEFAULT_HUNGER_FACTOR * 1.75

	min_age = 18
	max_age = 100

	description = "Sergals are the native race of a planet named Tal, a planet covered by sprawling megacities and districts. Run by corporations and criminal cartels, the planet lies in a system that is now controlled by the Sol Central Government. Tal is a protectorate under the SCG, and while the Solarian authority and cartel families attempt to bring Tal in as a proper member world with full citizenship, corporate bodies both on and off-world intend to preserve the status quo of near-unrestricted capitalism."
