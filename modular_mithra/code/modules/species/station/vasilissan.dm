/datum/species/vasilissan
	...
	unarmed_types = list(/datum/unarmed_attack/stomp, /datum/unarmed_attack/kick, /datum/unarmed_attack/punch, /datum/unarmed_attack/bite/sharp, /datum/unarmed_attack/claws, /datum/unarmed_attack/bite/venom)
	darksight_range = 16
	...
	spawn_flags = SPECIES_IS_ICONBASE | SPECIES_CAN_JOIN | SPECIES_FLAG_NO_POISON | SPECIES_FLAG_NO_EMBED | SPECIES_FLAG_NO_TANGLE
