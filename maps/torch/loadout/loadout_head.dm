...
datum/gear/head/slouchflat
	display_name = "Australian slouch hat, unpinned"
	description = "An ancient piece of headgear. Looks durable-ish."
	path = /obj/item/clothing/head/soft/slouchflat

datum/gear/head/slouchpinned
	display_name = "Australian slouch hat, pinned"
	description = "An ancient piece of headgear. Looks durable-ish, with a slight nod to style."
	path = /obj/item/clothing/head/soft/slouchpinned
