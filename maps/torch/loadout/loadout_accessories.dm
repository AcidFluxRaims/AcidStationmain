...
/datum/gear/accessory/solawardminor
	display_name = "minor award selection, additonal"
	description = "A medal or ribbon awarded to military and paramilitary personnel for minor accomplishments."
	path = /obj/item/clothing/accessory
	cost = 2

/datum/gear/accessory/solawardminor
	display_name = "minor award selection, tertiary"
	description = "A medal or ribbon awarded to military and paramilitary personnel for minor accomplishments."
	path = /obj/item/clothing/accessory
	cost = 2
...
/datum/gear/accessory/torch_patch
	display_name = "IFSS Independence mission patch"
	path = /obj/item/clothing/accessory/solgov/torch_patch
	description = "A shoulder patch representing the IFSS Independence and its mission. Given to all crewmembers aboard the Independence."
...
/datum/gear/tactical/pistol
	display_name = "NT Mk58 semi-auto pistol"
	description = "The NT Mk58 is a cheap, ubiquitous sidearm, produced by a NanoTrasen subsidiary. Found pretty much everywhere humans are. Can take double-stack 10mm magazines."
	path = /obj/item/weapon/gun/projectile/pistol/sec
	cost = 4
	allowed_roles = ARMORED_ROLES

/datum/gear/tactical/navypistol
	display_name = "HT Optimus semi-auto pistol"
	description = "The HelTek Optimus, best known as the standard-issue sidearm for the UCG Navy. Can take double-stack 10mm magazines."
	path = /obj/item/weapon/gun/projectile/pistol/military/alt
	cost = 6
	allowed_roles = ARMORED_ROLES

/datum/gear/tactical/marinepistol
	display_name = "HI P-20 semi-auto pistol"
	description = "The Hephaestus Industries P20 - a mass produced kinetic sidearm in widespread service. Can take double-stack 10mm magazines."
	path = /obj/item/weapon/gun/projectile/pistol/military
	cost = 6
	allowed_roles = ARMORED_ROLES

/datum/gear/tactical/holdoutpistol
	display_name = "P3 Whisper"
	description = "The Lumoco Arms P3 Whisper. A small, easily concealable gun. Takes 7mm magazines."
...
/datum/gear/tactical/colt1911
	display_name = "Colt M1911A1 .45 ACP"
	description = "An ancient Earth firearm that may or may not be genuine."
	path = /obj/item/weapon/gun/projectile/pistol/throwback
	cost = 6
	allowed_roles = ARMORED_ROLES

/datum/gear/tactical/ber92
	display_name = "Beretta 92FS 9mm Parabellum"
	description = "An ancient Earth firearm that may or may not be genuine."
	path = /obj/item/weapon/gun/projectile/pistol/throwback/pistol4
	cost = 6
	allowed_roles = ARMORED_ROLES

/datum/gear/tactical/sig220
	display_name = "SIG P-220 .45 ACP"
	description = "An ancient Earth firearm that may or may not be genuine."
	path = /obj/item/weapon/gun/projectile/pistol/throwback/pistol2
	cost = 6
	allowed_roles = ARMORED_ROLES

/datum/gear/tactical/cz75
	display_name = "CZ75 9mm Parabellum"
	description = "An ancient Earth firearm that may or may not be genuine."
	path = /obj/item/weapon/gun/projectile/pistol/throwback/pistol3
	cost = 6
	allowed_roles = ARMORED_ROLES